window.TEST_FIXTURE_BANK = {
  ...
  questions: [
    ...
    {id:'F003',number:3,domain:'general',target:'Identify a primary color',stem:'Which of these is a primary color in additive light mixing?',options:{A:'Red',B:'Green',C:'Blue',D:'All of the above'},answer:'D'},
    {id:'F004',number:4,domain:'general',target:'Read a comparison',stem:'Which value is greatest?',options:{A:'12',B:'21',C:'18',D:'9'},answer:'B'}
  ]
};